...
- **C23 / C2x** (`c2x-starter`) — same layout, C23 compile flags (MSVC vs GCC/Clang handled in CMake)
...
| Feature | C99 (`c99-starter`) | C23 (`c2x-starter`) |
| --- | --- | --- |
| Interactive template picker | yes | yes |
| Non-interactive `--template` | yes | yes |
| `--standard c99` / `--standard c23` | yes | yes |
